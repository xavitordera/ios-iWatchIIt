...
public extension UICollectionView {
  /**
   Register a NIB-Based `UICollectionViewCell` subfinal class (conforming to `Reusable` & `NibLoadable`)

   - parameter cellType: the `UICollectionViewCell` (`Reusable` & `NibLoadable`-conforming) subfinal class to register
  ...
  /**
   Register a Class-Based `UICollectionViewCell` subfinal class (conforming to `Reusable`)

   - parameter cellType: the `UICollectionViewCell` (`Reusable`-conforming) subfinal class to register
  ...
  /**
   Returns a reusable `UICollectionViewCell` object for the final class inferred by the return-type

   - parameter indexPath: The index path specifying the location of the cell.
   - parameter cellType: The cell final class to dequeue
  ...
  /**
   Register a NIB-Based `UICollectionReusableView` subfinal class (conforming to `Reusable` & `NibLoadable`)
  ...
  /**
   Register a Class-Based `UICollectionReusableView` subfinal class (conforming to `Reusable`) as a Supplementary View

   - parameter supplementaryViewType: the `UIView` (`Reusable`-conforming) subfinal class to register as Supplementary View
   - parameter elementKind: The kind of supplementary view to create.
  ...
  /**
   Returns a reusable `UICollectionReusableView` object for the final class inferred by the return-type

   - parameter elementKind: The kind of supplementary view to retrieve.
   - parameter indexPath:   The index path specifying the location of the cell.
   - parameter viewType: The view final class to dequeue
